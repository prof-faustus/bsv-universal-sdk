// Pure view-model: maps engine state → exactly what the screen shows. No React here, so it is unit-
// testable in Node. The UI is a thin render of this. Enumerates legal actions only — never selects
